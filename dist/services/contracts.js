        ...
        switch (_a.label) {
            case 0:
                ...
                return [4, protocolContractInstance.methods
                        .kernel_hash(addresses, values, parseInt(data.offerExpiry, 10), data.creatorSalt, parseInt(data.interestRatePerDay, 10), parseInt(data.loanDuration, 10))
                        .call()];
            case 1:
                orderHash = _a.sent();
                return [4, protocolContractInstance.methods
            ...
            case 2:
                ...
                protocolContractInstance.methods
                    .cancel_kernel(addresses, values, parseInt(data.offerExpiry, 10), data.creatorSalt, parseInt(data.interestRatePerDay, 10), parseInt(data.loanDuration, 10), data.ecSignatureCreator, web3Utils.toWei(cancelledCollateralTokenAmount))
                    .send({ from: metamask.address })
